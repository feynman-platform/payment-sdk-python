...
class OpenExchangeRateApi:
    ...
    def currency_conversion1(
        ...
        :param currency_conversion_request_dto: (required)
        :type currency_conversion_request_dto: CurrencyConversionRequestDto
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BuyBtcResponseCurrencyConversionResponseDto",
        }
    ...
    def currency_conversion1_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BuyBtcResponseCurrencyConversionResponseDto]:
        """币种转换
    ...
    def _currency_conversion1_serialize(
        ...
        if currency_conversion_request_dto is not None:
            _body_params = currency_conversion_request_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/open/exchange/rate/currency/conversion',
