...
class PaymentOrderPaginationQuery(BaseModel):
    ...
    wallet_id: Optional[StrictStr] = Field(default=None, description="支付钱包ID", alias="walletId")
    wallet_type: Optional[StrictStr] = Field(default=None, description="钱包类型", alias="walletType")
    __properties: ClassVar[List[str]] = ["id", "orderByCreateAt", "createAtSince", "createAtUntil", "orderId", "merchantId", "channelId", "type", "currency", "amount", "fee", "orderStatus", "prepaymentOrderId", "walletId", "walletType"]
