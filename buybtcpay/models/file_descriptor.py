...
class FileDescriptor(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["proto", "messageTypes", "enumTypes", "services", "extensions", "dependencies", "publicDependencies", "syntax", "edition", "editionName", "name", "package", "file", "fullName", "options"]
