...
class EnumReservedRangeOrBuilder(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["start", "end", "initializationErrorString", "defaultInstanceForType", "descriptorForType", "allFields", "unknownFields", "initialized"]
...
EnumReservedRangeOrBuilder.model_rebuild(raise_errors=False)
