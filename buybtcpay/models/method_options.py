...
class MethodOptions(BaseModel):
    ...
    idempotency_level: Optional[StrictStr] = Field(default=None, alias="idempotencyLevel")
    ...
    default_instance_for_type: Optional[MethodOptions] = Field(default=None, alias="defaultInstanceForType")
    ...
    __properties: ClassVar[List[str]] = ["unknownFields", "featuresOrBuilder", "uninterpretedOptionList", "uninterpretedOptionOrBuilderList", "uninterpretedOptionCount", "idempotencyLevel", "features", "initialized", "serializedSize", "deprecated", "parserForType", "defaultInstanceForType", "allFields", "allFieldsRaw", "initializationErrorString", "descriptorForType", "memoizedSerializedSize"]

    @field_validator('idempotency_level')
    def idempotency_level_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['IDEMPOTENCY_UNKNOWN', 'NO_SIDE_EFFECTS', 'IDEMPOTENT']):
            raise ValueError("must be one of enum values ('IDEMPOTENCY_UNKNOWN', 'NO_SIDE_EFFECTS', 'IDEMPOTENT')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultInstanceForType": MethodOptions.from_dict(obj["defaultInstanceForType"]) if obj.get("defaultInstanceForType") is not None else None,
...
MethodOptions.model_rebuild(raise_errors=False)
