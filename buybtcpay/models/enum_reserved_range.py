...
class EnumReservedRange(BaseModel):
    """
    EnumReservedRange
    """ # noqa: E501
    ...
    default_instance_for_type: Optional[EnumReservedRange] = Field(default=None, alias="defaultInstanceForType")
    ...
    __properties: ClassVar[List[str]] = ["unknownFields", "initialized", "start", "end", "serializedSize", "parserForType", "defaultInstanceForType", "initializationErrorString", "descriptorForType", "allFields", "memoizedSerializedSize"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultInstanceForType": EnumReservedRange.from_dict(obj["defaultInstanceForType"]) if obj.get("defaultInstanceForType") is not None else None,
...
EnumReservedRange.model_rebuild(raise_errors=False)
