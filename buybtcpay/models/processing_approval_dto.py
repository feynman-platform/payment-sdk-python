...
class ProcessingApprovalDto(BaseModel):
    """
    ProcessingApprovalDto
    """ # noqa: E501
    id: StrictStr
    approval_status: StrictStr = Field(description="审批状态", alias="approvalStatus")
    approval_comment: StrictStr = Field(alias="approvalComment")
    __properties: ClassVar[List[str]] = ["id", "approvalStatus", "approvalComment"]
