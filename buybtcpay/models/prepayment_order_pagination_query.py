...
class PrepaymentOrderPaginationQuery(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "orderByCreateAt", "createAtSince", "createAtUntil", "businessId", "merchantId", "channelId", "amount", "currency", "orderStatus", "paymentOrderId"]
