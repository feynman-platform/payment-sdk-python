...
class PayPaginationPalmPayVirtualAccountOrderRechargeEntity(BaseModel):
    """
    ...
    data: Optional[List[PalmPayVirtualAccountOrderRechargeEntity]] = None
    __properties: ClassVar[List[str]] = ["total", "current", "size", "pages", "latest", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [PalmPayVirtualAccountOrderRechargeEntity.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
