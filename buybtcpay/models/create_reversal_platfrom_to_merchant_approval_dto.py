...
class CreateReversalPlatfromToMerchantApprovalDto(BaseModel):
    """
    冲销：平台到商户资金钱包
    """ # noqa: E501
    merchant_id: StrictStr = Field(description="向谁转账", alias="merchantId")
    amount: StrictStr = Field(description="货币标准计量单位，注意，此处是字符类型。金额不能大于平台的充值金额")
