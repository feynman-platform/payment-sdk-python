...
class MarketOrderDetailOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["makerOrderId", "takerOrderId", "fillSellQuantity", "fillBuyQuantity", "initializationErrorString", "unknownFields", "defaultInstanceForType", "descriptorForType", "allFields", "initialized"]
