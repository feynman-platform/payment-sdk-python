...
class MarketOrderDetailOrBuilder(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["makerOrderId", "takerOrderId", "fillSellQuantity", "fillBuyQuantity", "initializationErrorString", "defaultInstanceForType", "descriptorForType", "allFields", "unknownFields", "initialized"]
