...
class EnumOptionsOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deprecatedLegacyJsonFieldConflicts", "featuresOrBuilder", "uninterpretedOptionList", "uninterpretedOptionOrBuilderList", "uninterpretedOptionCount", "allowAlias", "features", "deprecated", "defaultInstanceForType", "initializationErrorString", "unknownFields", "descriptorForType", "allFields", "initialized"]
