...
class BuyBtcResponseWalletPermissionEntity(BaseModel):
    """
    ...
    data: Optional[WalletPermissionEntity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": WalletPermissionEntity.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
