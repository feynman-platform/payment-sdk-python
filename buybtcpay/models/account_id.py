...
class AccountId(BaseModel):
    ...
    name: Optional[ByteString] = None
    address: Optional[ByteString] = None
    ...
    default_instance_for_type: Optional[AccountId] = Field(default=None, alias="defaultInstanceForType")
    ...
    __properties: ClassVar[List[str]] = ["unknownFields", "initialized", "name", "address", "serializedSize", "parserForType", "defaultInstanceForType", "initializationErrorString", "descriptorForType", "allFields", "memoizedSerializedSize"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": ByteString.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "address": ByteString.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "serializedSize": obj.get("serializedSize"),
            "parserForType": obj.get("parserForType"),
            "defaultInstanceForType": AccountId.from_dict(obj["defaultInstanceForType"]) if obj.get("defaultInstanceForType") is not None else None,
...
AccountId.model_rebuild(raise_errors=False)
