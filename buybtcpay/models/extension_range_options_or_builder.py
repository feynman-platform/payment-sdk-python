...
class ExtensionRangeOptionsOrBuilder(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["declarationOrBuilderList", "declarationCount", "verification", "featuresOrBuilder", "uninterpretedOptionList", "uninterpretedOptionOrBuilderList", "uninterpretedOptionCount", "declarationList", "features", "defaultInstanceForType", "initializationErrorString", "unknownFields", "descriptorForType", "allFields", "initialized"]
...
ExtensionRangeOptionsOrBuilder.model_rebuild(raise_errors=False)
