...
class ServiceOptions(BaseModel):
    ...
    default_instance_for_type: Optional[ServiceOptions] = Field(default=None, alias="defaultInstanceForType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultInstanceForType": ServiceOptions.from_dict(obj["defaultInstanceForType"]) if obj.get("defaultInstanceForType") is not None else None,
...
ServiceOptions.model_rebuild(raise_errors=False)
