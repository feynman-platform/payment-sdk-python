...
class OneofOptions(BaseModel):
    ...
    default_instance_for_type: Optional[OneofOptions] = Field(default=None, alias="defaultInstanceForType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultInstanceForType": OneofOptions.from_dict(obj["defaultInstanceForType"]) if obj.get("defaultInstanceForType") is not None else None,
...
OneofOptions.model_rebuild(raise_errors=False)
