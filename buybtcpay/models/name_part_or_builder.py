...
class NamePartOrBuilder(BaseModel):
    """
    NamePartOrBuilder
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["namePart", "namePartBytes", "isExtension", "initializationErrorString", "unknownFields", "defaultInstanceForType", "descriptorForType", "allFields", "initialized"]
...
NamePartOrBuilder.model_rebuild(raise_errors=False)
