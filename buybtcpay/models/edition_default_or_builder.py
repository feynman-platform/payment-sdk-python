...
class EditionDefaultOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["edition", "valueBytes", "value", "initializationErrorString", "defaultInstanceForType", "descriptorForType", "allFields", "unknownFields", "initialized"]
