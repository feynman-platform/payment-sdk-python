...
class ExtensionRange(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["unknownFields", "optionsOrBuilder", "initialized", "options", "start", "end", "serializedSize", "parserForType", "defaultInstanceForType", "initializationErrorString", "descriptorForType", "allFields", "memoizedSerializedSize"]
