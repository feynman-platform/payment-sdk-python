...
class PalmPayNotifyEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createAt", "updateAt", "merchantId", "orderId", "orderNo", "amount", "currency", "orderStatus", "completeTime", "errorCode", "sign", "payerBankCode", "payerBankName", "payerAccountNo", "payerAccountName"]
