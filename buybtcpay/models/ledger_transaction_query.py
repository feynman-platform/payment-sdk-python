...
class LedgerTransactionQuery(BaseModel):
    ...
    merchant_tag: Optional[List[StrictStr]] = Field(default=None, description="商户标签", alias="merchantTag")
    ...
    __properties: ClassVar[List[str]] = ["id", "orderByCreateAt", "createAtSince", "createAtUntil", "merchantTag", "businessId", "channelId", "businessType", "accountType", "accountNo", "parentMerchantId", "direction", "currency", "amount", "balance", "walletId", "walletType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "merchantTag": obj.get("merchantTag"),
