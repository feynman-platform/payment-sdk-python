...
class MerchantWalletEntity(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="钱包类型")
    available: Optional[BuyBtcMoneyJsonValue] = None
    frozen: Optional[BuyBtcMoneyJsonValue] = None
    version: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "createAt", "updateAt", "merchantId", "type", "available", "frozen", "version"]
