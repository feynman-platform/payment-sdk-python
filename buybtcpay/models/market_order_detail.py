...
class MarketOrderDetail(BaseModel):
    ...
    maker_order_id: Optional[ByteString] = Field(default=None, alias="makerOrderId")
    taker_order_id: Optional[ByteString] = Field(default=None, alias="takerOrderId")
    fill_sell_quantity: Optional[StrictInt] = Field(default=None, alias="fillSellQuantity")
    fill_buy_quantity: Optional[StrictInt] = Field(default=None, alias="fillBuyQuantity")
    ...
    default_instance_for_type: Optional[MarketOrderDetail] = Field(default=None, alias="defaultInstanceForType")
    ...
    __properties: ClassVar[List[str]] = ["unknownFields", "makerOrderId", "takerOrderId", "fillSellQuantity", "fillBuyQuantity", "initialized", "serializedSize", "parserForType", "defaultInstanceForType", "initializationErrorString", "descriptorForType", "allFields", "memoizedSerializedSize"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of maker_order_id
        if self.maker_order_id:
            _dict['makerOrderId'] = self.maker_order_id.to_dict()
        # override the default output from pydantic by calling `to_dict()` of taker_order_id
        if self.taker_order_id:
            _dict['takerOrderId'] = self.taker_order_id.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "makerOrderId": ByteString.from_dict(obj["makerOrderId"]) if obj.get("makerOrderId") is not None else None,
            "takerOrderId": ByteString.from_dict(obj["takerOrderId"]) if obj.get("takerOrderId") is not None else None,
            "fillSellQuantity": obj.get("fillSellQuantity"),
            "fillBuyQuantity": obj.get("fillBuyQuantity"),
            "initialized": obj.get("initialized"),
            "serializedSize": obj.get("serializedSize"),
            "parserForType": obj.get("parserForType"),
            "defaultInstanceForType": MarketOrderDetail.from_dict(obj["defaultInstanceForType"]) if obj.get("defaultInstanceForType") is not None else None,
...
MarketOrderDetail.model_rebuild(raise_errors=False)
