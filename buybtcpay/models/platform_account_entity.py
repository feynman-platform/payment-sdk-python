...
class PlatformAccountEntity(BaseModel):
    """
    ...
    account_code: Optional[Dict[str, Any]] = Field(default=None, description="平台账户类型", alias="accountCode")
    account_name: Optional[StrictStr] = Field(default=None, alias="accountName")
    balance: Optional[BuyBtcMoneyJsonValue] = None
    version: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "createAt", "updateAt", "accountCode", "accountName", "balance", "version"]
