...
class Message(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["parserForType", "serializedSize", "initialized", "defaultInstanceForType", "initializationErrorString", "unknownFields", "descriptorForType", "allFields"]
