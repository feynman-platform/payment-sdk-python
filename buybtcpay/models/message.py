...
class Message(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["parserForType", "serializedSize", "initialized", "defaultInstanceForType", "initializationErrorString", "descriptorForType", "allFields", "unknownFields"]
