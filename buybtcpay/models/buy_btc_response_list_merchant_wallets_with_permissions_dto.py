...
class BuyBtcResponseListMerchantWalletsWithPermissionsDto(BaseModel):
    """
    ...
    data: Optional[List[MerchantWalletsWithPermissionsDto]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "detail", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [MerchantWalletsWithPermissionsDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
