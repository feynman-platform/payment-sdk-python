...
class PayoutRequestDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestTime", "version", "nonce", "orderId", "title", "description", "payeeName", "payeeBankCode", "payeeBankAccNo", "amount", "notifyUrl", "remark", "currency"]
