...
class SendPayoutNotifyDto(BaseModel):
    """
    SendPayoutNotifyDto
    """ # noqa: E501
    verify_code: StrictStr = Field(alias="verifyCode")
    order_id: StrictStr = Field(alias="orderId")
    currency: StrictStr
    order_status: StrictInt = Field(alias="orderStatus")
    __properties: ClassVar[List[str]] = ["verifyCode", "orderId", "currency", "orderStatus"]
