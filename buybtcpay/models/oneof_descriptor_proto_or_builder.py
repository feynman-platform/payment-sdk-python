...
class OneofDescriptorProtoOrBuilder(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["optionsOrBuilder", "name", "options", "nameBytes", "initializationErrorString", "defaultInstanceForType", "descriptorForType", "allFields", "unknownFields", "initialized"]
...
OneofDescriptorProtoOrBuilder.model_rebuild(raise_errors=False)
