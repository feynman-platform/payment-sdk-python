...
class OneofDescriptorProtoOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["nameBytes", "optionsOrBuilder", "name", "options", "initializationErrorString", "unknownFields", "defaultInstanceForType", "descriptorForType", "allFields", "initialized"]
