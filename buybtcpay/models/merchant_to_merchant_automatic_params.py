...
class MerchantToMerchantAutomaticParams(BaseModel):
    ...
    payer: StrictStr = Field(description="付款方商户ID或邮箱")
    payee: StrictStr = Field(description="收款方商户ID或邮箱")
    payee_operator_id: Optional[StrictStr] = Field(default=None, description="如果不传，就使用钱包的拥有者", alias="payeeOperatorId")
    ...
    __properties: ClassVar[List[str]] = ["verification", "requestTime", "version", "nonce", "payer", "payee", "payeeOperatorId", "amount", "currency"]
