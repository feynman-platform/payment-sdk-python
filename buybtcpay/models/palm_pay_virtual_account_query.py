...
class PalmPayVirtualAccountQuery(BaseModel):
    """
    查询条件
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "orderByCreateAt", "createAtSince", "createAtUntil", "virtualAccountName", "virtualAccountNo", "accountStatus", "identityType", "email"]
