...
class TradeTransferAggregationDto(BaseModel):
    """
    合并支付预付单，只支持商户到商户的支付
    """ # noqa: E501
    ...
    business_ids: List[StrictStr] = Field(description="合并的预付单ID列表", alias="businessIds")
    ...
    payee_wallet_operator: StrictStr = Field(description="收款方的钱包是谁在操作", alias="payeeWalletOperator")
    operator: StrictStr = Field(description="商户ID")
    __properties: ClassVar[List[str]] = ["verification", "requestTime", "version", "nonce", "businessIds", "newBusinessId", "payer", "payee", "payeeWalletOperator", "operator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payer": obj.get("payer"),
            "payee": obj.get("payee"),
            "payeeWalletOperator": obj.get("payeeWalletOperator"),
