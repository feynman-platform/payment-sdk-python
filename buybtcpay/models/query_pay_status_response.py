...
class QueryPayStatusResponse(BaseModel):
    ...
    data: Optional[QueryPayStatusData] = None
    success: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["respCode", "respMsg", "data", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": QueryPayStatusData.from_dict(obj["data"]) if obj.get("data") is not None else None,
