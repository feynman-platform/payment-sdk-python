...
class AccountIdOrBuilder(BaseModel):
    """
    AccountIdOrBuilder
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "address", "initializationErrorString", "defaultInstanceForType", "descriptorForType", "allFields", "unknownFields", "initialized"]
