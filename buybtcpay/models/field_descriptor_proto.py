...
class FieldDescriptorProto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["unknownFields", "label", "nameBytes", "jsonName", "proto3Optional", "oneofIndex", "extendee", "optionsOrBuilder", "typeNameBytes", "extendeeBytes", "defaultValueBytes", "jsonNameBytes", "initialized", "name", "typeName", "type", "defaultValue", "number", "options", "serializedSize", "parserForType", "defaultInstanceForType", "initializationErrorString", "descriptorForType", "allFields", "memoizedSerializedSize"]
