...
class CreateReversalPlatformToBankApprovalDto(BaseModel):
    """
    冲销：平台到银行
    """ # noqa: E501
    bank_code: StrictStr = Field(alias="bankCode")
    bank_account: StrictStr = Field(description="收款银行账号", alias="bankAccount")
    amount: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["bankCode", "bankAccount", "amount", "currencyType", "note"]
