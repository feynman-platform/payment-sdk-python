...
class MerchantBillQuery(BaseModel):
    ...
    from_channel: Optional[StrictStr] = Field(default=None, description="查询渠道", alias="fromChannel")
    operator: Optional[StrictStr] = Field(default=None, description="发起查询的商户ID")
    ...
    merchant_id: Optional[List[StrictStr]] = Field(default=None, description="商户ID列表", alias="merchantId")
    ...
    wallet_id: Optional[List[StrictStr]] = Field(default=None, description="钱包ID", alias="walletId")
    __properties: ClassVar[List[str]] = ["id", "orderByCreateAt", "createAtSince", "createAtUntil", "fromChannel", "operator", "businessIds", "businessId", "channelId", "merchantId", "businessType", "accountType", "counterpartyAccountType", "accountNo", "counterpartyAccountNo", "direction", "billStatus", "currency", "amount", "walletType", "walletId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fromChannel": obj.get("fromChannel"),
