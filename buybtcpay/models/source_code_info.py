...
class SourceCodeInfo(BaseModel):
    """
    SourceCodeInfo
    """ # noqa: E501
    ...
    default_instance_for_type: Optional[SourceCodeInfo] = Field(default=None, alias="defaultInstanceForType")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.location_or_builder_list:
            for _item_location_or_builder_list in self.location_or_builder_list:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultInstanceForType": SourceCodeInfo.from_dict(obj["defaultInstanceForType"]) if obj.get("defaultInstanceForType") is not None else None,
...
SourceCodeInfo.model_rebuild(raise_errors=False)
