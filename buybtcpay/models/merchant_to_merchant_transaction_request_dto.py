...
class MerchantToMerchantTransactionRequestDto(BaseModel):
    """
    ...
    payer_merchant_email: StrictStr = Field(description="付款方商户ID", alias="payerMerchantEmail")
    payee_merchant_email: StrictStr = Field(description="收款方商户ID", alias="payeeMerchantEmail")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nonce": obj.get("nonce"),
            "payerMerchantEmail": obj.get("payerMerchantEmail"),
            "payeeMerchantEmail": obj.get("payeeMerchantEmail"),
