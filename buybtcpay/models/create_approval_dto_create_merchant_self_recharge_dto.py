...
class CreateApprovalDtoCreateMerchantSelfRechargeDto(BaseModel):
    """
    ...
    content: Optional[CreateMerchantSelfRechargeDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": CreateMerchantSelfRechargeDto.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
        return _obj
