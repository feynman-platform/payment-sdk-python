...
class ResultOrBuilder(BaseModel):
    """
    ResultOrBuilder
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["retValue", "contractRetValue", "contractRet", "orderId", "fee", "exchangeId", "ret", "assetIssueID", "assetIssueIDBytes", "withdrawAmount", "unfreezeAmount", "exchangeReceivedAmount", "exchangeInjectAnotherAmount", "exchangeWithdrawAnotherAmount", "shieldedTransactionFee", "orderDetailsList", "orderDetailsOrBuilderList", "orderDetailsCount", "withdrawExpireAmount", "cancelUnfreezeV2AmountCount", "cancelUnfreezeV2Amount", "cancelUnfreezeV2AmountMap", "initializationErrorString", "defaultInstanceForType", "descriptorForType", "allFields", "unknownFields", "initialized"]
