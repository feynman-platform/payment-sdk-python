...
class DeclarationOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fullNameBytes", "typeBytes", "reserved", "type", "number", "fullName", "repeated", "initializationErrorString", "unknownFields", "defaultInstanceForType", "descriptorForType", "allFields", "initialized"]
