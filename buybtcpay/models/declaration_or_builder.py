...
class DeclarationOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fullNameBytes", "typeBytes", "reserved", "type", "number", "fullName", "repeated", "initializationErrorString", "defaultInstanceForType", "descriptorForType", "allFields", "unknownFields", "initialized"]
