...
class MerchantMoneyUsageStatisticsReq(BaseModel):
    """
    统计商户币种消耗情况
    """ # noqa: E501
    merchant_id: StrictStr = Field(alias="merchantId")
    start_time: StrictStr = Field(description="开始-结束时间相差不能超过6个月", alias="startTime")
    end_time: StrictStr = Field(alias="endTime")
    group_by_hour: Optional[StrictBool] = Field(default=None, description="是否按小时分组，默认按天", alias="groupByHour")
    currency: StrictStr = Field(description="货币类型")
    __properties: ClassVar[List[str]] = ["merchantId", "startTime", "endTime", "groupByHour", "currency"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groupByHour": obj.get("groupByHour"),
