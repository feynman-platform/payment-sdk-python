...
class CreateVirtualAccountRechargeApprovalDto(BaseModel):
    """
    如果主商户资金账户余额不够，则无法充值
    """ # noqa: E501
    ...
    wallet_id: StrictStr = Field(description="商户钱包ID，要求为资金账户", alias="walletId")
    ...
    __properties: ClassVar[List[str]] = ["amount", "currencyType", "walletId", "note", "dmerchantId"]
