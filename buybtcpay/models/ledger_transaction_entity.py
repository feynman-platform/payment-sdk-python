...
class LedgerTransactionEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createAt", "updateAt", "businessId", "channelId", "businessType", "accountType", "accountNo", "direction", "amount", "balance", "walletId", "walletType", "counterpartyAccountType", "counterpartyAccountNo", "counterpartyWalletId", "extra"]
