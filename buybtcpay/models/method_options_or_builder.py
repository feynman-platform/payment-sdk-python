...
class MethodOptionsOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["featuresOrBuilder", "uninterpretedOptionList", "uninterpretedOptionOrBuilderList", "uninterpretedOptionCount", "idempotencyLevel", "features", "deprecated", "defaultInstanceForType", "initializationErrorString", "descriptorForType", "allFields", "unknownFields", "initialized"]
