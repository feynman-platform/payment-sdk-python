...
class CreateReversalMerchantToPlatformApprovalDto(BaseModel):
    """
    冲销：商户到平台
    """ # noqa: E501
    merchant_id: StrictStr = Field(description="谁向平台转账", alias="merchantId")
    ...
    __properties: ClassVar[List[str]] = ["merchantId", "amount", "currencyType", "note"]
