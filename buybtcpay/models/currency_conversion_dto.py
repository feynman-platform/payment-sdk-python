...
class CurrencyConversionDto(BaseModel):
    ...
    amount: StrictStr
    time_id: StrictStr = Field(alias="timeId")
    note: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["verification", "requestTime", "version", "nonce", "payer", "payee", "sourceCurrency", "targetCurrency", "amount", "timeId", "note"]
