...
class RateListQueryOptions(BaseModel):
    """
    ...
    has_total: Optional[StrictBool] = Field(default=None, alias="hasTotal")
    __properties: ClassVar[List[str]] = ["ids", "currency", "status", "hasTotal"]
