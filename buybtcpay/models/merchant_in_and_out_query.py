...
class MerchantInAndOutQuery(BaseModel):
    """
    商户收支查询条件
    """ # noqa: E501
    ...
    amount: Optional[List[StrictStr]] = Field(default=None, description="金额")
    balance: Optional[List[StrictStr]] = Field(default=None, description="余额")
    __properties: ClassVar[List[str]] = ["id", "orderByCreateAt", "createAtSince", "createAtUntil", "currency", "amount", "balance"]
