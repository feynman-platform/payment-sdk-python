...
class PayPaginationQueryLedgerTransactionLatestMerchantAccountQuery(BaseModel):
    """
    分页查询
    """ # noqa: E501
    ...
    query: Optional[LedgerTransactionLatestMerchantAccountQuery] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "query": LedgerTransactionLatestMerchantAccountQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
