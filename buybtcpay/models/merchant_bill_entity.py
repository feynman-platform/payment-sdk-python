...
class MerchantBillEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createAt", "updateAt", "businessId", "merchantId", "channelId", "businessType", "accountType", "accountNo", "direction", "amount", "counterpartyAccountType", "counterpartyAccountNo", "billStatus", "extra"]
