...
class LedgerTransactionLatestVirtualAccountQuery(BaseModel):
    """
    查询条件
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "orderByCreateAt", "createAtSince", "createAtUntil", "parentMerchantId"]
