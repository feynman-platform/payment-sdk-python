...
class DataCMRate(BaseModel):
    ...
    list: Optional[List[CMRate]] = None
    __properties: ClassVar[List[str]] = ["total", "page", "size", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "page": obj.get("page"),
            "size": obj.get("size"),
            "list": [CMRate.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
