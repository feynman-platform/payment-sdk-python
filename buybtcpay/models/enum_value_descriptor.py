...
class EnumValueDescriptor(BaseModel):
    """
    EnumValueDescriptor
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["index", "proto", "fullName", "type", "name", "file", "number", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "index": obj.get("index"),
            "proto": EnumValueDescriptorProto.from_dict(obj["proto"]) if obj.get("proto") is not None else None,
            "fullName": obj.get("fullName"),
            "type": EnumDescriptor.from_dict(obj["type"]) if obj.get("type") is not None else None,
            "name": obj.get("name"),
...
EnumValueDescriptor.model_rebuild(raise_errors=False)
