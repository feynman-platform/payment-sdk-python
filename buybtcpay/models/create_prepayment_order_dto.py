...
class CreatePrepaymentOrderDto(BaseModel):
    """
    创建预付订单请求参数
    """ # noqa: E501
    ...
    operator: StrictStr = Field(description="代付平台的商户ID，可以是商户ID，也可以是子商户ID，只要拥有钱包的对应权限")
    type: StrictInt = Field(description="0: Merchant to merchant, 1: Payout, 2: Withdrawal, 3: Trade transfer")
    ...
    __properties: ClassVar[List[str]] = ["verification", "requestTime", "version", "nonce", "businessId", "operator", "type", "amount", "currency", "payeeBankCode", "walletId"]
