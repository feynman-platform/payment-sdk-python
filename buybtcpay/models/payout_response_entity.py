...
class PayoutResponseEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createAt", "updateAt", "merchantId", "orderId", "merchantOrderId", "amount", "orderStatus", "sessionId", "message", "errorMsg", "merchantFee", "respCode", "respMsg"]
