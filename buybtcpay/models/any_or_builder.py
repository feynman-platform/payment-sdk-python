...
class AnyOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["typeUrl", "typeUrlBytes", "value", "initializationErrorString", "unknownFields", "defaultInstanceForType", "descriptorForType", "allFields", "initialized"]
