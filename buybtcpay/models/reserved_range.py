...
class ReservedRange(BaseModel):
    ...
    default_instance_for_type: Optional[ReservedRange] = Field(default=None, alias="defaultInstanceForType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultInstanceForType": ReservedRange.from_dict(obj["defaultInstanceForType"]) if obj.get("defaultInstanceForType") is not None else None,
...
ReservedRange.model_rebuild(raise_errors=False)
