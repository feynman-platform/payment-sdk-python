...
class MerchantEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createAt", "updateAt", "merchantId", "publicKey", "name", "email", "role", "merchantStatus", "palmPayVirtualAccountNo", "note", "virtualAccountId", "tag", "version"]
