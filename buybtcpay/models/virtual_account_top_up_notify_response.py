...
class VirtualAccountTopUpNotifyResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["orderNo", "orderStatus", "createdTime", "updateTime", "currency", "orderAmount", "reference", "payerAccountNo", "payerAccountName", "payerBankName", "virtualAccountNo", "virtualAccountName", "accountReference", "sessionId", "sign"]
