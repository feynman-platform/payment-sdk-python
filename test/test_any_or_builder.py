...
class TestAnyOrBuilder(unittest.TestCase):
    """AnyOrBuilder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnyOrBuilder:
        """Test AnyOrBuilder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnyOrBuilder`
        """
        model = AnyOrBuilder()
        if include_optional:
            return AnyOrBuilder(
