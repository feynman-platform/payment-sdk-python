...
class TestEnumDescriptor(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnumDescriptor:
        """Test EnumDescriptor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnumDescriptor`
        """
        model = EnumDescriptor()
        if include_optional:
            return EnumDescriptor(
                ...
                values = [
                    buybtcpay.models.enum_value_descriptor.EnumValueDescriptor(
                        index = 56, 
                        proto = buybtcpay.models.enum_value_descriptor_proto.EnumValueDescriptorProto(
                            unknown_fields = buybtcpay.models.unknown_field_set.UnknownFieldSet(
                                serialized_size_as_message_set = 56, 
                                initialized = True, 
                                serialized_size = 56, 
