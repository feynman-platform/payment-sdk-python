...
class TestEnumReservedRange(unittest.TestCase):
    """EnumReservedRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnumReservedRange:
        """Test EnumReservedRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnumReservedRange`
        """
        model = EnumReservedRange()
        if include_optional:
    ...
    def testEnumReservedRange(self):
        """Test EnumReservedRange"""
