...
class TestExtensionRange(unittest.TestCase):
    """ExtensionRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtensionRange:
        """Test ExtensionRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtensionRange`
        """
        model = ExtensionRange()
        if include_optional:
