...
class TestDescriptorProto(unittest.TestCase):
    """DescriptorProto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescriptorProto:
        """Test DescriptorProto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescriptorProto`
        """
        ...
        if include_optional:
            return DescriptorProto(
                ...
                serialized_size = 56,
                parser_for_type = buybtcpay.models.parser_descriptor_proto.ParserDescriptorProto(),
                default_instance_for_type = buybtcpay.models.descriptor_proto.DescriptorProto(
                    unknown_fields = buybtcpay.models.unknown_field_set.UnknownFieldSet(
                        serialized_size_as_message_set = 56, 
                        initialized = True, 
                        serialized_size = 56, 
