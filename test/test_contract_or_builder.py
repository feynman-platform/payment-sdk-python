...
class TestContractOrBuilder(unittest.TestCase):
    """ContractOrBuilder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContractOrBuilder:
        """Test ContractOrBuilder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractOrBuilder`
        """
        model = ContractOrBuilder()
        if include_optional:
    ...
    def testContractOrBuilder(self):
        """Test ContractOrBuilder"""
