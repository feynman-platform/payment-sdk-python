...
class TestReservedRangeOrBuilder(unittest.TestCase):
    """ReservedRangeOrBuilder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReservedRangeOrBuilder:
        """Test ReservedRangeOrBuilder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReservedRangeOrBuilder`
        """
        model = ReservedRangeOrBuilder()
        if include_optional:
            return ReservedRangeOrBuilder(
                start = 56,
                end = 56,
    ...
    def testReservedRangeOrBuilder(self):
        """Test ReservedRangeOrBuilder"""
