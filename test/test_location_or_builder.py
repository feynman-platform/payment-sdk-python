...
class TestLocationOrBuilder(unittest.TestCase):
    """LocationOrBuilder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocationOrBuilder:
        """Test LocationOrBuilder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocationOrBuilder`
        """
        model = LocationOrBuilder()
        if include_optional:
            return LocationOrBuilder(
                path_list = [
                    56
                    ],
                path_count = 56,
    ...
    def testLocationOrBuilder(self):
        """Test LocationOrBuilder"""
