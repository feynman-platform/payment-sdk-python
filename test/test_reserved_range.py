...
class TestReservedRange(unittest.TestCase):
    """ReservedRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReservedRange:
        """Test ReservedRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReservedRange`
        """
        model = ReservedRange()
        if include_optional:
