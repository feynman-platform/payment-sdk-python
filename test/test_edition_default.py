...
class TestEditionDefault(unittest.TestCase):
    """EditionDefault unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditionDefault:
        """Test EditionDefault
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditionDefault`
        """
        model = EditionDefault()
        if include_optional:
