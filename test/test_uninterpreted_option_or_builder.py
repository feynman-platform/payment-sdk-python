...
class TestUninterpretedOptionOrBuilder(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UninterpretedOptionOrBuilder:
        """Test UninterpretedOptionOrBuilder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UninterpretedOptionOrBuilder`
        """
        model = UninterpretedOptionOrBuilder()
        if include_optional:
            return UninterpretedOptionOrBuilder(
                name_list = [
