...
class TestEnumReservedRangeOrBuilder(unittest.TestCase):
    """EnumReservedRangeOrBuilder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnumReservedRangeOrBuilder:
        """Test EnumReservedRangeOrBuilder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnumReservedRangeOrBuilder`
        """
        model = EnumReservedRangeOrBuilder()
        if include_optional:
            return EnumReservedRangeOrBuilder(
                start = 56,
                end = 56,
    ...
    def testEnumReservedRangeOrBuilder(self):
        """Test EnumReservedRangeOrBuilder"""
