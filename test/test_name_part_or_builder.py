...
class TestNamePartOrBuilder(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NamePartOrBuilder:
        """Test NamePartOrBuilder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamePartOrBuilder`
        """
        model = NamePartOrBuilder()
        if include_optional:
            return NamePartOrBuilder(
