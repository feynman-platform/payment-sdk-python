...
class TestRaw(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Raw:
        """Test Raw
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Raw`
        """
        model = Raw()
        if include_optional:
            return Raw(
                ...
                scripts = buybtcpay.models.byte_string.ByteString(
                    empty = True, 
                    valid_utf8 = True, ),
                parser_for_type = buybtcpay.models.parser_raw.ParserRaw(),
                default_instance_for_type = buybtcpay.models.raw.raw(
                    unknown_fields = buybtcpay.models.unknown_field_set.UnknownFieldSet(
                        serialized_size_as_message_set = 56, 
                        initialized = True, 
                        serialized_size = 56, 
