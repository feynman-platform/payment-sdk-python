...
class TestAccountIdOrBuilder(unittest.TestCase):
    """AccountIdOrBuilder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountIdOrBuilder:
        """Test AccountIdOrBuilder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountIdOrBuilder`
        """
        model = AccountIdOrBuilder()
        if include_optional:
    ...
    def testAccountIdOrBuilder(self):
        """Test AccountIdOrBuilder"""
