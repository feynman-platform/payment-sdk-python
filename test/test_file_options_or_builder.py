...
class TestFileOptionsOrBuilder(unittest.TestCase):
    """FileOptionsOrBuilder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileOptionsOrBuilder:
        """Test FileOptionsOrBuilder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileOptionsOrBuilder`
        """
        model = FileOptionsOrBuilder()
        if include_optional:
            return FileOptionsOrBuilder(
