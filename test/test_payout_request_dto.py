...
class TestPayoutRequestDto(unittest.TestCase):
    """PayoutRequestDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutRequestDto:
        """Test PayoutRequestDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutRequestDto`
        """
