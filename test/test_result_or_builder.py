...
class TestResultOrBuilder(unittest.TestCase):
    """ResultOrBuilder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultOrBuilder:
        """Test ResultOrBuilder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultOrBuilder`
        """
        model = ResultOrBuilder()
        if include_optional:
                ...
                order_details_list = [
                    buybtcpay.models.market_order_detail.MarketOrderDetail(
                        ...
                        maker_order_id = buybtcpay.models.byte_string.ByteString(
                            empty = True, 
                            valid_utf8 = True, ), 
                        taker_order_id = buybtcpay.models.byte_string.ByteString(
                            empty = True, 
                            valid_utf8 = True, ), 
